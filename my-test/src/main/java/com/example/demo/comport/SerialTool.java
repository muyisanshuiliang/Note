package com.example.demo.comport;
...
import com.example.demo.comport.exception.*;
...
public class SerialTool {
     ...
     * @throws NotAerielPortException 端口指向设备不是串口类型
     * @throws NoSuchPortException 没有该端口对应的串口设备
     * @throws PortInUseException 端口已被占用
     */
    public static final SerialPort openPort(String portName, int baudrate) throws SerialPortParameterFailure, NotAerielPortException, NoSuchPortException, PortInUseException {
        ...
        try {
            ...
            if (commPort instanceof SerialPort) {
                ...
                //不是串口
                throw new NotAerielPortException();
            }
